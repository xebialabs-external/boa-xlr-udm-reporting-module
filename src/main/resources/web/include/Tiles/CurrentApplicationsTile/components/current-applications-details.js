import './current-applications-details.less';
...
const template = `
    <div class="modal-header">
        ...
        <button type="button" class="close pull-right" ng-click="$ctrl.close()"><span>&times;</span></button>
        <div class="clearfix" />
    </div>
...
class CurrentApplicationsDetailsController {
...
export const currentApplicationsDetailsComponent = {
    bindings: {
        resolve: '<',
        close: '&',
    },
